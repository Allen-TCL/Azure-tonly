...
You also can use tftp to copy the executable to Kiwi Mini.  As the same way of http sample, please transfer iothub_client_sample_mqtt and iothub_client_sample_amqp to Kiwi Mini.
...
On the Kiwi Mini device, install the ca-certificates package like below:
...
Also you can use curl tool to download the ipk.
